...
let products: Iproducts[] = [
  ...
  },
  {
    ...
    oldPrice: "$160",
    discountPercent: "-30%",
    image_url: "/grid/grid-pic-4.png",
  },
];

export default function TailwindGrid1() {
  return (
    <div className="w-full overflow-auto mt-10 mb-10">
