...
export default async function Sale() {
  ...
  const discountedProducts: ProductType[] = await client.fetch(`
     *[_type == "products" && discountPercent > 0 ]{
      _id,
      name,
      price,
        discountPercent,
          ...
          <div className=" w-[100%] border-[1px] rounded-2xl border-[#e6e6e6] flex-col p-4 items-center justify-between">
            ...
            <div className="w-full flex-col justify-between items-center">
              <div className="w-full flex justify-between items-center mt-4">
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-green-700 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                ...
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-red-700 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#b91c1c]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-yellow-400 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#facc15]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-orange-600 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#ea580c]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-blue-400 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
              ...
              <div className="w-full flex justify-between items-center mt-4">
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-blue-800 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#1e40af]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-purple-600 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#9333ea]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-pink-600 rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-[#db2777]">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-white rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
                  <p className="text-white">.</p>
                </div>
                <div
                  className=" cursor-pointer w-[30px] h-[30px] bg-black rounded-full border-[1px] border-[#e6e6e6]
              transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300"
                >
            ...
            <div
              className="transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300 cursor-pointer
            ...
            <div className=" w-[80%] flex items-center justify-between">
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="flex w-[100%] text-xs justify-center items-center">
                  <p id="sh-box" className="text-[#787878] w-full ">
                    Showing 1-10 of 100 Products
                  </p>
                  <p id="mp-box" className="text-[#787878] w-full">
            ...
            <Pagination>
              <PaginationContent>
                ...
                <PaginationItem className="hover:bg-[#f0f0f0] border-[1px] border-[#e6e6e6] hover transform motion-safe:hover:-translate-y-1 motion-safe:hover:scale-110 transition ease-in-out duration-300 w-[28%] flex justify-end md-[680px]:justify-center">
                  <PaginationNext
                    className=" text-xs md-[850]:text-bs"
                    href="#"
                  />
                </PaginationItem>
              </PaginationContent>
